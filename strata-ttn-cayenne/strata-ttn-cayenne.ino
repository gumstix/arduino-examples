/*  
 *   This is an example sketch for the Gumstix Strata ATmega32U4 LoRa 
 *   The tree's lights turn on when the room is occupied and deactivates
 *   sensor node. It delivers relative humidity, temperature and barometric 
 *   pressure to the Cayenne application via thethingsnetwork.org
 *   
